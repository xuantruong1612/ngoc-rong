 ...
 *
 */
public class Fide1 extends FutureBoss {

    public Fide1() {
        super(BossFactory.Fide1, BossData.Fide1  );
    }
    ...
    protected boolean useSpecialSkill() {
     ...
     @Override
       ...
       if (Util.isTrue(10, 100)) { // tỉ lệ 30 k vv
            Service.getInstance().dropItemMap(this.zone, Util.CAITRANG1(zone, caitrang[listcaitrang], 1,  this.location.x-30, this.location.y, pl.id));
