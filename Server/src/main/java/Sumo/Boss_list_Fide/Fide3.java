 ...
 *
 */
public class Fide3 extends FutureBoss {

    public Fide3() {
        super(BossFactory.Fide3, BossData.Fide3  );
    }
    ...
    protected boolean useSpecialSkill() {
     ...
     @Override
       ...
       if (Util.isTrue(10, 100)) { // tỉ lệ 30 k vv
            Service.getInstance().dropItemMap(this.zone, Util.CAITRANG3(zone, caitrang[listcaitrang], 1,  this.location.x-30, this.location.y, pl.id));
