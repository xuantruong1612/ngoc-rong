 ...
 *
 */
public class panchi extends FutureBoss {

    public panchi() {
        super(BossFactory.panchi, BossData.panchi);
    }
    ...
    public void rewards(Player pl) {
        ...
        if (Util.isTrue(50, 100)) { // Tỉ lệ 50%
            ...
            for (int i = 0; i < slcarot3; i++) {
                ItemMap carot = new ItemMap(zone, Util.nextInt(421, 433), 1, 10 * i + this.location.x,
                        zone.map.yPhysicInTop(this.location.x, 0), -1);
              carot.options.add(new ItemOption(209, Util.nextInt(10, 500)));
                carot.options.add(new ItemOption(208, Util.nextInt(1, 10)));
