 ...
 *
 */
public class BOSS_TRUNGQUY1 extends FutureBoss {

    public BOSS_TRUNGQUY1() {
        super(BossFactory.BOSS_TRUNGQUY1, BossData.BOSS_TRUNGQUY1);
    }
    ...
    public void rewards(Player pl) {
      ...
      int slcarot = Util.nextInt(1, 20);
        for (int i = 0; i < slcarot; i++) {
            ItemMap carot = new ItemMap(zone, 1092, 1, 10 * i + this.location.x, zone.map.yPhysicInTop(this.location.x, 0), -1);
