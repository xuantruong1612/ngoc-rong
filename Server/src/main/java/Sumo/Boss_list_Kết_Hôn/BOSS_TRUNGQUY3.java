 ...
 *
 */
public class BOSS_TRUNGQUY3 extends FutureBoss {

    public BOSS_TRUNGQUY3() {
        super(BossFactory.BOSS_TRUNGQUY3, BossData.BOSS_TRUNGQUY3);
    }
    ...
    public void rewards(Player pl) {
      ...
      int slcarot = Util.nextInt(1, 20);
        for (int i = 0; i < slcarot; i++) {
            ItemMap carot = new ItemMap(zone, 1094, 1, 10 * i + this.location.x, zone.map.yPhysicInTop(this.location.x, 0), -1);
