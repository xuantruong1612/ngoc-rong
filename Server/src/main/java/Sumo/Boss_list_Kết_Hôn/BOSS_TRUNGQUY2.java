package Sumo.Boss_list_Kết_Hôn;
 ...
 *
 */
public class BOSS_TRUNGQUY2 extends FutureBoss {

    public BOSS_TRUNGQUY2() {
        super(BossFactory.BOSS_TRUNGQUY2, BossData.BOSS_TRUNGQUY2);
    }
    ...
    public void rewards(Player pl) {
      ...
      int slcarot = Util.nextInt(1, 20);
        for (int i = 0; i < slcarot; i++) {
            ItemMap carot = new ItemMap(zone, 1093, 1, 10 * i + this.location.x, zone.map.yPhysicInTop(this.location.x, 0), -1);
