 ...
 *
 */
public class Thiensuwhis extends FutureBoss {

    public Thiensuwhis() {
        super(BossFactory.THIENSUWISH, BossData.THIENSUWISH);
    }
    ...
    public void rewards(Player pl) {
        ...
        if (Util.isTrue(10, 100)) { // Tỉ lệ 50%
            ...
            for (int i = 0; i < slcarot3; i++) {
                ...
                carot.options.add(new ItemOption(58, Util.nextInt(1, 6000)));
                carot.options.add(new ItemOption(52, Util.nextInt(1,6000)));
                carot.options.add(new ItemOption(53, Util.nextInt(10, 6000)));
                carot.options.add(new ItemOption(54, Util.nextInt(1, 6000)));
                carot.options.add(new ItemOption(55, Util.nextInt(1, 10)));
                carot.options.add(new ItemOption(61, Util.nextInt(1, 10)));
                carot.options.add(new ItemOption(107, Util.nextInt(1, 60)));
