 ...
 *
 */
public class obito extends FutureBoss {

    public obito() {
        super(BossFactory.obito, BossData.obito);
    }
    ...
    public void rewards(Player pl) {
      ...
      int slcarot = Util.nextInt(6, 20);
        for (int i = 0; i < slcarot; i++) {
            ItemMap carot = new ItemMap(zone,  Util.nextInt(14, 20), 1, 10 * i + this.location.x, zone.map.yPhysicInTop(this.location.x, 0), -1);
