 ...
 *
 */
public class linhthu2 extends FutureBoss {

    public linhthu2() {
        super(BossFactory.linhthu2, BossData.linhthu2);
    }
    ...
    public void rewards(Player pl) {
        ...
        if (Util.isTrue(50, 100)) { // Tỉ lệ 50%
            ...
            for (int i = 0; i < slcarot3; i++) {
              ...
              carot.options.add(new ItemOption(50, Util.nextInt(10, 700)));
                carot.options.add(new ItemOption(77, Util.nextInt(10, 700)));
                carot.options.add(new ItemOption(103, Util.nextInt(10, 700)));
