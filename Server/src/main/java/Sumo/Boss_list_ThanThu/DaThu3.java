 ...
 *
 */
public class DaThu3 extends FutureBoss {

    public DaThu3() {
        super(BossFactory.DaThu3, BossData.DaThu3  );
    }
    ...
    protected boolean useSpecialSkill() {
     ...
     @Override
       ...
       if (Util.isTrue(10, 100)) { // tỉ lệ 30 k vv
            Service.getInstance().dropItemMap(this.zone, Util.dathu3(zone, PET[LISTPET], 1,  this.location.x-30, this.location.y, pl.id));
