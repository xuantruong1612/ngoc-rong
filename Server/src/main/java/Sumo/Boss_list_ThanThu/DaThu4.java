 ...
 *
 */
public class DaThu4 extends FutureBoss {

    public DaThu4() {
        super(BossFactory.DaThu4, BossData.DaThu4  );
    }
    ...
    protected boolean useSpecialSkill() {
     ...
     @Override
       ...
       if (Util.isTrue(10, 100)) { // tỉ lệ 30 k vv
            Service.getInstance().dropItemMap(this.zone, Util.dathu4(zone, PET[LISTPET], 1,  this.location.x-30, this.location.y, pl.id));
