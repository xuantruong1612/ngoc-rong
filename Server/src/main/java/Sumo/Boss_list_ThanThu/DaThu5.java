 ...
 *
 */
public class DaThu5 extends FutureBoss {

    public DaThu5() {
        super(BossFactory.DaThu5, BossData.DaThu5  );
    }
    ...
    protected boolean useSpecialSkill() {
     ...
     @Override
       ...
       if (Util.isTrue(10, 100)) { // tỉ lệ 30 k vv
            Service.getInstance().dropItemMap(this.zone, Util.dathu5(zone, PET[LISTPET], 1,  this.location.x-30, this.location.y, pl.id));
