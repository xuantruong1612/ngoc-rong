 ...
 *
 */
public class DaThu8 extends FutureBoss {

    public DaThu8() {
        super(BossFactory.DaThu8, BossData.DaThu8  );
    }
    ...
    protected boolean useSpecialSkill() {
     ...
     @Override
       ...
       if (Util.isTrue(10, 100)) { // tỉ lệ 30 k vv
            Service.getInstance().dropItemMap(this.zone, Util.dathu8(zone, PET[LISTPET], 1,  this.location.x-30, this.location.y, pl.id));
