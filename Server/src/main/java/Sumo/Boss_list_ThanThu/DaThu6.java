 ...
 *
 */
public class DaThu6 extends FutureBoss {

    public DaThu6() {
        super(BossFactory.DaThu6, BossData.DaThu6  );
    }
    ...
    protected boolean useSpecialSkill() {
     ...
     @Override
       ...
       if (Util.isTrue(10, 100)) { // tỉ lệ 30 k vv
            Service.getInstance().dropItemMap(this.zone, Util.dathu6(zone, PET[LISTPET], 1,  this.location.x-30, this.location.y, pl.id));
