 ...
 *
 */
public class DaThu1 extends FutureBoss {

    public DaThu1() {
        super(BossFactory.DaThu1, BossData.DaThu1  );
    }
    ...
    protected boolean useSpecialSkill() {
     ...
     @Override
       ...
       if (Util.isTrue(10, 100)) { // tỉ lệ 30 k vv
            Service.getInstance().dropItemMap(this.zone, Util.dathu1(zone, PET[LISTPET], 1,  this.location.x-30, this.location.y, pl.id));
