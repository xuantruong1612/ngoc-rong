 ...
 *
 */
public class DaThu7 extends FutureBoss {

    public DaThu7() {
        super(BossFactory.DaThu7, BossData.DaThu7  );
    }
    ...
    protected boolean useSpecialSkill() {
     ...
     @Override
       ...
       if (Util.isTrue(10, 100)) { // tỉ lệ 30 k vv
            Service.getInstance().dropItemMap(this.zone, Util.dathu7(zone, PET[LISTPET], 1,  this.location.x-30, this.location.y, pl.id));
