 ...
 *
 */
public class Sanji extends FutureBoss {

    public Sanji() {
        super(BossFactory.Sanji, BossData.Sanji);
    }
    ...
    public void rewards(Player pl) {
      ...
      int slcarot = Util.nextInt(6, 30);
        for (int i = 0; i < slcarot; i++) {
            ItemMap carot = new ItemMap(zone, 995, 1, 10 * i + this.location.x, zone.map.yPhysicInTop(this.location.x, 0), -1);
