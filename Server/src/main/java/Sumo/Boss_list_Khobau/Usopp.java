 ...
 *
 */
public class Usopp extends FutureBoss {

    public Usopp() {
        super(BossFactory.Usopp, BossData.Usopp);
    }
    ...
    public void rewards(Player pl) {
      ...
      int slcarot = Util.nextInt(6, 50);
        for (int i = 0; i < slcarot; i++) {
            ItemMap carot = new ItemMap(zone, 993, 1, 10 * i + this.location.x, zone.map.yPhysicInTop(this.location.x, 0), -1);
