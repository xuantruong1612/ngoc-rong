 ...
 *
 */
public class Brook extends FutureBoss {

    public Brook() {
        super(BossFactory.Brook, BossData.Brook);
    }
    ...
    public void rewards(Player pl) {
      ...
      int slcarot = Util.nextInt(6, 30);
        for (int i = 0; i < slcarot; i++) {
            ItemMap carot = new ItemMap(zone, 996, 1, 10 * i + this.location.x, zone.map.yPhysicInTop(this.location.x, 0), -1);
