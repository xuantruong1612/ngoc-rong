 ...
 *
 */
public class chanmenh5 extends FutureBoss {

    public chanmenh5() {
        super(BossFactory.chanmenh5, BossData.chanmenh5);
    }
    ...
    public void rewards(Player pl) {
        ...
        if (Util.isTrue(50, 100)) { // Tỉ lệ 50%
            ...
            for (int i = 0; i < slcarot3; i++) {
                ItemMap carot = new ItemMap(zone, Util.nextInt(1360, 1363), 1, 10 * i + this.location.x,
